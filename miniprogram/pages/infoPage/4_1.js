  ...
  */
  ...
  onLoad: function (options) {
    wx.cloud.getTempFileURL({
      fileList: ['cloud://s-d314c0.732d-s-d314c0/images/4_1_1.jpg', 'cloud://s-d314c0.732d-s-d314c0/images/4_1_2.jpg', 'cloud://s-d314c0.732d-s-d314c0/audio/4_1.mp3'],
      success: res => {
        this.setData({
        ...
        this.audioCtx.src = res['fileList'][2]['tempFileURL'];
      },
      fail: console.error
    });
  },
